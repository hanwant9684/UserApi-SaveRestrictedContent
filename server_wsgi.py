        ...
        try:
            ...
            try:
                ...
                if cloud_service:
                    ...
                    # Ensure API credential columns exist (for user API migration)
                    try:
                        import sqlite3
                        ...
                        conn.commit()
                        conn.close()
                        _logger.info("✅ Database schema updated with API credential columns")
                    except Exception as e:
                        _logger.warning(f"Could not ensure API columns: {e}")
